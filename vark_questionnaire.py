# Dahan TIMINAI ; 202412232

# Custom exception for invalid answers
class InvalidAnswerException(Exception):
    """Exception raised for invalid questionnaire answers."""
    pass
    ...
    def get_valid_answer(self, prompt, options, exclude=None):
        ...
        while True:
            try:
                ...
                if ans == 'q':
                    print("Exiting the questionnaire. Thank you!")
                    return 'q'
                if ans not in options or (exclude is not None and ans == exclude):
                    raise InvalidAnswerException("Invalid choice or already selected. Please enter a different option (a, b, c, or d).")
                return ans
